...
import os  # Added for host key file operations
...
def run_ssh_command():
    """Secure SSH connections with proper host key verification"""
    ...
    # This warns about unknown hosts but still allows connections
